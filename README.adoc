...
This workshops requires a OpenShift environment with user already defined. They must be named as `user`+ `number`, like `user1`, and have the same password, `openshift`.
